...
if(isset($_POST['lastmsg'])) {
	...
	echo '<div class="admin-rows"><div class="one columns">'.$unique.'</div><div class="three columns"><a href="'.$conf['url'].'/profile/'.$username.'">'.$username.'</a></div><div class="seven columns">'.$email.'</div><div class="one columns"><a href="'.$conf['url'].'/index.php?a=admin&b=users&delete='.$unique.'"><img src="'.$conf['url'].'/images/icons/delete.png" /></a></div></div>'; 
